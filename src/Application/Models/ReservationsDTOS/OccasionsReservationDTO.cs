...
{
    public class OccasionsReservationAddDTO : IMapFrom<OccasionsReservation>
    {
    ...
    public class OccasionsReservationUpdateDTO : IMapFrom<OccasionsReservation>
    {
    ...
    public class OccasionsReservationResDTO : IMapFrom<OccasionsReservation>
    {
        public Guid Id { get; set; }
