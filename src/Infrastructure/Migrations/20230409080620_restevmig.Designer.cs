...
namespace Tawala.Infrastructure.Migrations
{
    ...
    [Migration("20230409080620_restevmig")]
    partial class restevmig
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tawala.Domain.Entities.Country.Country", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("IOS2")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Tawala.Domain.Entities.Favorite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Tawala.Domain.Entities.Identity.TempCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Tawala.Domain.Entities.Notifications.ClientNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Tawala.Domain.Entities.Offers", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Tawala.Domain.Entities.Orders.OrderItems", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("TotalWithAmount")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Tawala.Domain.Entities.Orders.Orders", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("TotalAftetrVat")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Tawala.Domain.Entities.Settings.EvaluationEN.Evaluation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Tawala.Domain.Entities.Settings.ResEvaluation.ResEvaluation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Tawala.Domain.Entities.Orders.OrderItems", b =>
                {
                    ...
                    b.HasOne("Tawala.Domain.Entities.Orders.Orders", "Orders")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("Tawala.Domain.Entities.Orders.Orders", b =>
                {
                    ...
                    b.HasOne("Tawala.Domain.Entities.Offers", "Offers")
                        .WithMany()
                        .HasForeignKey("OffersId");

                    b.HasOne("Tawala.Domain.Entities.Settings.OptionSetsEntities.OptionSetItem", "OrderStatus")
                        .WithMany()
            ...
            modelBuilder.Entity("Tawala.Domain.Entities.Settings.EvaluationEN.Evaluation", b =>
                {
                    b.HasOne("Tawala.Domain.Entities.Settings.OptionSetsEntities.OptionSetItem", "EvaluationType")
                        .WithMany()
